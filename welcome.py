...
def greet(name: str) -> str:
    ...
    >>> greet('Rutwa')
    'Hello Rutwa! Welcome to CSC148. Hope you have a great time this term. :)'
    >>> greet('Marc')
    'Hello Marc! Welcome to CSC148. Hope you have a great time this term. :)'
    >>> greet('Romina')
    'Hello Romina! Welcome to CSC148. Hope you have a great time this term. :)'
    """
